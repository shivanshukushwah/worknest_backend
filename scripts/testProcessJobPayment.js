(async ()=>{
  ...
  try{
    ...
    // ensure employer wallet has enough balance
    console.log('Calling job-payment as employer...')
    const res = await axios.post(`${base}/api/payments/job-payment/${jobId}`, {}, { headers: { Authorization: `Bearer ${tokenEmp}` } })
